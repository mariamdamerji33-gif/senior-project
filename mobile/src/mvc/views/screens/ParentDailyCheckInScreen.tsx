...
const styles = StyleSheet.create({
  ...
  sectionTitle: { color: '#24173f', fontWeight: '900', fontSize: 16 },
  ...
  chipActive: { backgroundColor: '#7c4dff', borderColor: '#7c4dff' },
  ...
  historyTitle: { color: '#24173f', fontWeight: '800' },
  historyLine: { color: '#5f5573', lineHeight: 20 },
})
