...
const styles = StyleSheet.create({
  ...
  summary: { color: '#0f172a', fontWeight: '600' },
  ...
  speechBox: { marginTop: 6, backgroundColor: '#fff', borderRadius: 12, borderWidth: 1, borderColor: '#cbd5e1', padding: 12 },
  speechTitle: { color: '#64748b', marginBottom: 4 },
  speechText: { color: '#0f172a', fontSize: 18, fontWeight: '700' },
  historyBox: { backgroundColor: '#fff', borderRadius: 12, borderWidth: 1, borderColor: '#cbd5e1', padding: 12 },
  historyTitle: { color: '#64748b', marginBottom: 4 },
  historyText: { color: '#0f172a' },
