...
const styles = StyleSheet.create({
  ...
  summary: { color: '#2c2144', fontWeight: '600' },
  ...
  icon: { fontSize: 30 },
  label: { color: '#2c2144', fontWeight: '700' },
  speechBox: { marginTop: 6, backgroundColor: '#fff', borderRadius: 12, borderWidth: 1, borderColor: '#e2daf7', padding: 12 },
  speechTitle: { color: '#6d6485', marginBottom: 4 },
  speechText: { color: '#2c2144', fontSize: 18, fontWeight: '700' },
  historyBox: { backgroundColor: '#fff', borderRadius: 12, borderWidth: 1, borderColor: '#e2daf7', padding: 12 },
  historyTitle: { color: '#6d6485', marginBottom: 4 },
  historyText: { color: '#2c2144' },
