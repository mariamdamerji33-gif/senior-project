...
const styles = StyleSheet.create({
  ...
  title: { color: '#24173f', fontSize: 16, fontWeight: '900' },
  body: { color: '#5f5573', lineHeight: 20, fontWeight: '600' },
  ...
  timeoutChipActive: { borderColor: '#6b3df0', backgroundColor: '#ede6ff' },
  timeoutChipText: { color: '#6b3df0', fontWeight: '800' },
  timeoutChipTextActive: { color: '#4c1d95' },
  timeoutMeta: { color: '#7c7392', fontSize: 11, fontWeight: '700' },
  timeoutMetaActive: { color: '#5b21b6' },
