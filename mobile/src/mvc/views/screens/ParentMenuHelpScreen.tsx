...
const COPY = {
  en: {
    ...
    rows: [
      ...
      { icon: '🔔', name: 'Alerts', text: 'School notifications in one list. On Today, tap the bell at the top right of the purple home card (next to language). The slim purple bar on the left no longer has alerts.' },
    ],
  },
  ar: {
    ...
    rows: [
      ...
      { icon: '🔔', name: 'تنبيهات', text: 'إشعارات المدرسة في قائمة واحدة. في صفحة اليوم، اضغط الجرس أعلى اليمين في البطاقة البنفسجية (بجانب اللغة). الشريط البنفسجي الضيق على اليسار لم يعد فيه تنبيهات.' },
    ],
  },
} as const
