...
const styles = StyleSheet.create({
  ...
  langBtnActive: { backgroundColor: '#f1eaff' },
  ...
  heroIconText: { color: '#7c4dff', fontSize: 30, fontWeight: '900' },
  ...
  progressTitle: { color: '#2c2144', fontSize: 18, fontWeight: '900' },
  progressText: { color: '#5f5573', lineHeight: 20 },
  ...
  activityTitle: { color: '#2c2144', fontSize: 18, fontWeight: '900' },
  activityHint: { color: '#6d6485', lineHeight: 19 },
  activityStartHint: { color: '#6b3df0', fontSize: 12, fontWeight: '900', marginTop: 2, textTransform: 'uppercase', letterSpacing: 0.4 },
  activityArrow: { color: '#7c4dff', fontSize: 30, fontWeight: '900' },
})
