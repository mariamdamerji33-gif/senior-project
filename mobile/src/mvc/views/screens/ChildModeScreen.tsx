...
const ACTIVITY_META: { id: ChildModeActivityId; icon: string; color: string; route: ActivityItem['route'] }[] = [
  { id: 'pecs', icon: '▣', color: '#1d4ed8', route: 'ChildPecs' },
...
const styles = StyleSheet.create({
  ...
  langText: { fontWeight: '800', color: '#64748b', fontSize: 13 },
  langTextActive: { color: '#1e40af' },
  ...
  heroBubbleLarge: {
    ...
    height: 160,
    borderRadius: 80,
    backgroundColor: 'rgba(37, 99, 235,0.46)',
    top: -66,
    right: -46,
  },
  heroBubbleSmall: {
  ...
  heroIconText: { color: '#1d4ed8', fontSize: 30, fontWeight: '900' },
  eyebrow: { color: '#93c5fd', fontWeight: '900', letterSpacing: 0.8, fontSize: 12 },
  ...
  progressTitle: { color: '#0f172a', fontSize: 18, fontWeight: '900' },
  progressText: { color: '#475569', lineHeight: 20 },
  ...
  activityTitle: { color: '#0f172a', fontSize: 18, fontWeight: '900' },
  activityHint: { color: '#64748b', lineHeight: 19 },
  activityStartHint: { color: '#1d4ed8', fontSize: 12, fontWeight: '900', marginTop: 2, textTransform: 'uppercase', letterSpacing: 0.4 },
  activityArrow: { color: '#1d4ed8', fontSize: 30, fontWeight: '900' },
})
