...
const styles = StyleSheet.create({
  ...
  progress: { color: '#2c2144', fontWeight: '700' },
  ...
  itemText: { color: '#2c2144', fontWeight: '600', flex: 1 },
  itemTextDone: { textDecorationLine: 'line-through', color: '#7c7392' },
  status: { marginTop: 6, color: '#5f5573' },
