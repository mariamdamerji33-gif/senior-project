...
const styles = StyleSheet.create({
  ...
  subtitle: { color: '#5f5573', marginBottom: 2, lineHeight: 22, fontWeight: '700' },
  ...
  weekHeading: { fontSize: 15, fontWeight: '800', color: '#2c2144', marginTop: 4 },
  list: { gap: 10 },
  videoCard: {
    backgroundColor: '#fff',
    borderRadius: 14,
  ...
  cardTitle: { color: '#2c2144', fontWeight: '800' },
