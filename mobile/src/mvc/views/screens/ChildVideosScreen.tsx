...
const styles = StyleSheet.create({
  ...
  subtitle: { color: '#475569', marginBottom: 2, lineHeight: 22, fontWeight: '700' },
  ...
  dailyLabel: { color: '#93c5fd', fontSize: 12, fontWeight: '900', letterSpacing: 0.8 },
  ...
  dailyText: { color: '#bfdbfe', lineHeight: 20 },
  dailyPracticeText: { color: '#fff', lineHeight: 20, fontWeight: '900', marginTop: 4 },
  practiceText: { color: '#475569', lineHeight: 20, fontWeight: '800', marginTop: 6 },
  dailyTip: { color: '#93c5fd', fontSize: 12, lineHeight: 17, marginTop: 4, opacity: 0.95 },
  dailyBtn: { marginTop: 6, backgroundColor: '#fff', borderRadius: 12, padding: 12, alignItems: 'center' },
  dailyBtnText: { color: '#1d4ed8', fontWeight: '900' },
  playerCard: {
    backgroundColor: '#fff',
    borderRadius: 16,
    borderWidth: 1,
  ...
  nowPlaying: { marginTop: 10, color: '#1d4ed8', fontSize: 12, fontWeight: '800' },
  videoTitle: { marginTop: 2, color: '#0f172a', fontWeight: '800', fontSize: 17 },
  videoDuration: { marginTop: 4, color: '#1d4ed8', fontSize: 12, fontWeight: '900' },
  videoTip: { marginTop: 6, color: '#64748b', fontSize: 12, lineHeight: 17 },
  weekHeading: { fontSize: 15, fontWeight: '800', color: '#0f172a', marginTop: 4 },
  list: { gap: 10 },
  videoCard: {
    backgroundColor: '#fff',
    borderRadius: 14,
  ...
  videoCardActive: { borderColor: '#1d4ed8', backgroundColor: '#dbeafe' },
  ...
  cardDay: { color: '#1d4ed8', fontSize: 12, fontWeight: '900', marginBottom: 4 },
  todayBadge: {
    fontSize: 11,
    fontWeight: '900',
    color: '#166534',
  ...
  cardDuration: { color: '#1d4ed8', marginTop: 4, fontSize: 12, fontWeight: '900' },
  cardText: { color: '#64748b', marginTop: 4, lineHeight: 19 },
  cardPractice: { color: '#475569', marginTop: 8, fontSize: 12, lineHeight: 17, fontWeight: '800' },
  cardTip: { color: '#94a3b8', marginTop: 8, fontSize: 12, lineHeight: 17 },
})
