...
const styles = StyleSheet.create({
  ...
  iconCircle: { width: 38, height: 38, borderRadius: 19, backgroundColor: '#ede6ff', alignItems: 'center', justifyContent: 'center' },
  iconText: { color: '#5f3dc9', fontWeight: '900', fontSize: 16 },
  itemBody: { flex: 1, gap: 4 },
  itemDate: { color: '#7c7392', fontSize: 12, fontWeight: '800' },
  itemTitle: { color: '#2c2144', fontWeight: '900', fontSize: 16 },
  itemText: { color: '#5f5573', lineHeight: 20, fontWeight: '600' },
