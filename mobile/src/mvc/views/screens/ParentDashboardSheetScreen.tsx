...
const styles = StyleSheet.create({
  ...
  statAccentPurple: { backgroundColor: '#1d4ed8' },
  statAccentTeal: { backgroundColor: '#0f766e' },
  statAccentBlue: { backgroundColor: '#2563eb' },
  statAccentPink: { backgroundColor: '#be185d' },
  statLabel: { color: '#64748b', fontWeight: '800', fontSize: 11, textTransform: 'uppercase', letterSpacing: 0.4 },
  statValue: { color: '#0f172a', fontWeight: '900', fontSize: 30 },
  statValueSmall: { color: '#0f172a', fontWeight: '900', fontSize: 18 },
  statHint: { color: '#64748b', fontSize: 11 },
  panelHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
  panelTitle: { color: '#0f172a', fontWeight: '900', fontSize: 16 },
  panelMeta: { color: '#1d4ed8', fontWeight: '900' },
  progressTrack: { height: 12, borderRadius: 999, backgroundColor: '#dbeafe', overflow: 'hidden', borderWidth: 1, borderColor: '#e3d9fb' },
