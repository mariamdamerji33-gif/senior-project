...
const styles = StyleSheet.create({
  ...
  statAccentPurple: { backgroundColor: '#7c4dff' },
  ...
  statValue: { color: '#2c2144', fontWeight: '900', fontSize: 30 },
  statValueSmall: { color: '#2c2144', fontWeight: '900', fontSize: 18 },
  statHint: { color: '#7c7392', fontSize: 11 },
  panelHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
  panelTitle: { color: '#2c2144', fontWeight: '900', fontSize: 16 },
