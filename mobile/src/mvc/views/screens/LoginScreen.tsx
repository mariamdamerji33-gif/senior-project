...
const styles = StyleSheet.create({
  ...
  createPill: { backgroundColor: '#f8f5ff', borderRadius: 999, paddingVertical: 8, paddingHorizontal: 10, borderWidth: 1, borderColor: '#e4d9ff' },
  createPillText: { color: '#5f3dc9', fontWeight: '900', fontSize: 12 },
  connectionLink: { alignItems: 'center', paddingVertical: 4 },
  connectionLinkText: { color: '#6b3df0', fontWeight: '800', textDecorationLine: 'underline', fontSize: 14 },
  ...
  forgotLink: { color: '#6b3df0', fontWeight: '800', fontSize: 13, textDecorationLine: 'underline' },
  ...
  status: { color: '#2c2144', fontWeight: '600', fontSize: 14 },
  error: { color: '#b42318', fontWeight: '600', fontSize: 14 },
  helpBox: { backgroundColor: '#faf7ff', borderRadius: 14, borderWidth: 1, borderColor: '#ece4ff', padding: 12, gap: 4 },
  helpTitle: { color: '#2c2144', fontWeight: '800', fontSize: 15 },
  helpText: { color: '#5f5573', lineHeight: 19, fontSize: 14 },
