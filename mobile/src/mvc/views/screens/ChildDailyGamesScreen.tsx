...
const styles = StyleSheet.create({
  ...
  gameNumberText: { color: '#6d46d4', fontSize: 18, fontWeight: '900' },
  gameHeaderText: { flex: 1, gap: 2 },
  gameTitle: { color: '#17131f', fontSize: 17, fontWeight: '900' },
  gameSubtitle: { color: '#6d6485', lineHeight: 19, fontWeight: '600' },
  prompt: { color: '#17131f', fontSize: 18, fontWeight: '900' },
  ...
  choiceIcon: { fontSize: 28, color: '#6d46d4' },
  blueIcon: { color: '#2563eb' },
  redIcon: { color: '#dc2626' },
  yellowIcon: { color: '#f59e0b' },
  choiceLabel: { color: '#17131f', fontSize: 12, fontWeight: '900', textAlign: 'center' },
  feedbackGood: { color: '#15803d', fontWeight: '900' },
  feedbackTry: { color: '#b45309', fontWeight: '800' },
  completeHint: { color: '#534c62', lineHeight: 20, fontWeight: '700', textAlign: 'center' },
  saveBtn: { backgroundColor: '#6d46d4', borderRadius: 14, padding: 13, alignItems: 'center' },
  btnDisabled: { opacity: 0.58 },
  saveBtnText: { color: '#fff', fontSize: 15, fontWeight: '900' },
  resetBtn: { backgroundColor: '#f4f1fb', borderRadius: 14, borderWidth: 1, borderColor: '#cfc4e6', padding: 12, alignItems: 'center' },
  resetBtnText: { color: '#6d46d4', fontWeight: '900' },
  inlineStatus: { color: '#17131f', textAlign: 'center', fontWeight: '700' },
