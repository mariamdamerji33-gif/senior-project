...
const styles = StyleSheet.create({
  ...
  heroProgress: { color: '#93c5fd', fontWeight: '900' },
  gameCard: {
    backgroundColor: '#fff',
    borderRadius: 22,
    borderWidth: 1,
  ...
  gameNumberText: { color: '#1d4ed8', fontSize: 18, fontWeight: '900' },
  gameHeaderText: { flex: 1, gap: 2 },
  gameTitle: { color: '#0f172a', fontSize: 17, fontWeight: '900' },
  gameSubtitle: { color: '#64748b', lineHeight: 19, fontWeight: '600' },
  prompt: { color: '#0f172a', fontSize: 18, fontWeight: '900' },
  chooseText: { color: '#64748b', fontSize: 12, fontWeight: '800', textTransform: 'uppercase' },
  ...
  choiceIcon: { fontSize: 28, color: '#1d4ed8' },
  blueIcon: { color: '#2563eb' },
  redIcon: { color: '#dc2626' },
  yellowIcon: { color: '#f59e0b' },
  choiceLabel: { color: '#0f172a', fontSize: 12, fontWeight: '900', textAlign: 'center' },
  feedbackGood: { color: '#15803d', fontWeight: '900' },
  feedbackTry: { color: '#b45309', fontWeight: '800' },
  completeHint: { color: '#475569', lineHeight: 20, fontWeight: '700', textAlign: 'center' },
  saveBtn: { backgroundColor: '#1d4ed8', borderRadius: 14, padding: 13, alignItems: 'center' },
  btnDisabled: { opacity: 0.58 },
  saveBtnText: { color: '#fff', fontSize: 15, fontWeight: '900' },
  resetBtn: { backgroundColor: '#dbeafe', borderRadius: 14, borderWidth: 1, borderColor: '#cbd5e1', padding: 12, alignItems: 'center' },
  resetBtnText: { color: '#1d4ed8', fontWeight: '900' },
  inlineStatus: { color: '#0f172a', textAlign: 'center', fontWeight: '700' },
  inlineError: { color: '#b91c1c', textAlign: 'center', fontWeight: '700' },
})
