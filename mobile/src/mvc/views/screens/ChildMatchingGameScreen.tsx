...
const styles = StyleSheet.create({
  ...
  moves: { color: '#2c2144', fontWeight: '700' },
  ...
  cardText: { fontSize: 34, color: '#2c2144' },
  status: { marginTop: 8, color: '#5f5573' },
  saveBtn: { marginTop: 4, backgroundColor: '#ede6ff', borderRadius: 10, padding: 12, alignItems: 'center' },
  saveBtnDisabled: { opacity: 0.6 },
  saveBtnText: { color: '#5f3dc9', fontWeight: '700' },
  resetBtn: { marginTop: 6, backgroundColor: '#6d46d4', borderRadius: 10, padding: 12, alignItems: 'center' },
