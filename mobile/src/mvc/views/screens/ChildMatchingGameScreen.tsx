...
const styles = StyleSheet.create({
  ...
  moves: { color: '#17131f', fontWeight: '700' },
  ...
  cardText: { fontSize: 34, color: '#17131f' },
  status: { marginTop: 8, color: '#534c62' },
  saveBtn: { marginTop: 4, backgroundColor: '#f4f1fb', borderRadius: 10, padding: 12, alignItems: 'center' },
