...
const styles = StyleSheet.create({
  ...
  unreadCard: { borderColor: '#1d4ed8', backgroundColor: '#eff6ff' },
  ...
  cardBody: { color: '#475569', lineHeight: 20, fontWeight: '600' },
  ...
  readFirstHint: { flex: 1, minWidth: 120, color: '#64748b', fontSize: 12, fontWeight: '600', lineHeight: 17 },
  deleteBtn: {
    borderRadius: 12,
    paddingVertical: 10,
