...
const styles = StyleSheet.create({
  ...
  helper: { color: '#2c2144', fontWeight: '600' },
  ...
  feelingCardActive: { borderColor: '#6d46d4', backgroundColor: '#ede6ff' },
  emoji: { fontSize: 28 },
  feelingLabel: { color: '#2c2144', fontWeight: '700' },
  tipCard: { backgroundColor: '#fff', borderRadius: 12, borderWidth: 1, borderColor: '#e2daf7', padding: 12, gap: 6 },
  tipTitle: { color: '#2c2144', fontWeight: '700' },
  tipText: { color: '#5f5573', lineHeight: 20 },
  input: {
    minHeight: 44,
    maxHeight: 90,
    backgroundColor: '#fff',
  ...
  saveBtn: { backgroundColor: '#ede6ff', borderRadius: 10, padding: 12, alignItems: 'center' },
