...
const styles = StyleSheet.create({
  ...
  subtitle: { color: '#5f5573', fontWeight: '700' },
  meta: { color: '#2c2144', fontWeight: '600' },
  phraseCard: { marginTop: 6, backgroundColor: '#fff', borderRadius: 12, borderWidth: 1, borderColor: '#e2daf7', padding: 14, gap: 8 },
  prompt: { color: '#6d6485' },
  phraseText: { color: '#2c2144', fontSize: 24, fontWeight: '700' },
  hint: { color: '#7c7392' },
  primaryBtn: { marginTop: 6, backgroundColor: '#6d46d4', borderRadius: 10, padding: 12, alignItems: 'center' },
  primaryBtnText: { color: '#fff', fontWeight: '700' },
  secondaryBtn: { backgroundColor: '#ede6ff', borderRadius: 10, padding: 12, alignItems: 'center' },
  secondaryBtnText: { color: '#5f3dc9', fontWeight: '700' },
  ghostBtn: { borderRadius: 10, borderWidth: 1, borderColor: '#d8cffa', padding: 12, alignItems: 'center' },
  ghostBtnText: { color: '#2c2144', fontWeight: '700' },
  saveBtn: { backgroundColor: '#6d46d4', borderRadius: 10, padding: 12, alignItems: 'center' },
  saveBtnDisabled: { opacity: 0.6 },
  saveBtnText: { color: '#fff', fontWeight: '700' },
  inlineStatus: { color: '#2c2144', textAlign: 'center' },
  inlineError: { color: '#b42318', textAlign: 'center' },
})
