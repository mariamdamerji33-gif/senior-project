...
const styles = StyleSheet.create({
  ...
  meta: { color: '#17131f', fontWeight: '600' },
  phraseCard: { marginTop: 6, backgroundColor: '#fff', borderRadius: 12, borderWidth: 1, borderColor: '#dfd6ee', padding: 14, gap: 8 },
  prompt: { color: '#6d6485' },
  phraseText: { color: '#17131f', fontSize: 24, fontWeight: '700' },
  hint: { color: '#7c7392' },
  primaryBtn: { marginTop: 6, backgroundColor: '#6d46d4', borderRadius: 10, padding: 12, alignItems: 'center' },
  primaryBtnText: { color: '#fff', fontWeight: '700' },
  secondaryBtn: { backgroundColor: '#f4f1fb', borderRadius: 10, padding: 12, alignItems: 'center' },
  secondaryBtnText: { color: '#5f3dc9', fontWeight: '700' },
  ghostBtn: { borderRadius: 10, borderWidth: 1, borderColor: '#cfc4e6', padding: 12, alignItems: 'center' },
  ghostBtnText: { color: '#17131f', fontWeight: '700' },
